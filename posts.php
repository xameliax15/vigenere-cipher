...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="posts.php" class="active"><i class="fas fa-file-alt"></i> Posts</a></li>
    ...
    <div class="main-content">
        <div class="breadcrumb">
            <i class="fas fa-home"></i> Home &nbsp;>&nbsp; Posts
        </div>
        <div class="page-title">Posts</div>
        <div class="card">
            <a href="add_post.php" class="btn btn-primary" style="margin-bottom:18px;"><i class="fas fa-plus"></i> Add Post</a>
            <table>
                <thead>
                    <tr>
                        <th>Title</th>
                ...
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit_post.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
                            <form action="posts.php" method="post" style="display:inline;">
                                <input type="hidden" name="post_id" value="<?php echo $row['id']; ?>">
                                <button type="submit" name="delete_post" class="btn btn-danger btn-sm" onclick="return confirm('Delete this post?')"><i class="fas fa-trash"></i></button>
                            </form>
                        </td>
                    </tr>
                <?php endwhile; ?>
